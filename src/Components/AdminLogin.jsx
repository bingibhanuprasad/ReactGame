...
const AdminLogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    axios.get("https://signupuser-72c40-default-rtdb.firebaseio.com/AdminRegister.json")
      .then((response) => {
 ...
 <div className="element">
        ...
        <p className="signup-text">
          Don't have an account? <Link to="/AdminSignUp" className="signup-link">Sign Up</Link>
        </p>
      </div>
    </div>
    </>
