...
const CoinSellerLogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    axios.get("https://signupuser-72c40-default-rtdb.firebaseio.com/CoinSellerRegister.json")
      .then((response) => {
    ...
    <div className="login-container">
      ...
      <div className="login-box">
        ...
        <p className="signup-text">
          Don't have an account? <Link to="/CoinSellerSignup" className="signup-link">Sign Up</Link>
        </p>
      </div>
    </div>
  );
...
export default CoinSellerLogin;
