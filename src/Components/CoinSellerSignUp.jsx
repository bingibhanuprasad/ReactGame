...
const CoinSellerSignUp = () => {
  ...
  const handleSignUp = (e) => {
    ...
    axios
      .post('https://signupuser-72c40-default-rtdb.firebaseio.com/CoinSellerRegister.json', signUpData)
      .then(() => {
    ...
    <div className="login-container">
      <div className="login-box">
        ...
        <p className="signup-text">
          Already have an account? <Link to="/StreamLogin" className="signup-link">Login</Link>
        </p>
      </div>
    </div>
  );
...
export default CoinSellerSignUp;
